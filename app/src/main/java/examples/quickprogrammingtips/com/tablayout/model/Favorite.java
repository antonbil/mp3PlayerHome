...
public class Favorite {
    public static ArrayList<String> categoryIds=new ArrayList<>(Arrays.asList("2nd edition","3","4","5","6","7","8"));
    private static ArrayList<String> categoryDescriptions=new ArrayList<>(Arrays.asList("New Links","Classical","Symphonic Rock","Electronic","Soul","Singer/Songwriter","Various"));
